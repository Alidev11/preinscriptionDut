<?php
    ...
    $pdf->Ln();
    $pdf->Ln();
    $pdf->Cell(0,10,"Liste d'attente",0,1,'C');
    $pdf->Ln();
    $pdf->Ln();
    ...
    $k = 1;
    if(isset($_SESSION["arraySliced"]) && isset($_SESSION["nbEtudiantAdmin"])){
        $arraySliced = $_SESSION["arraySliced"];
